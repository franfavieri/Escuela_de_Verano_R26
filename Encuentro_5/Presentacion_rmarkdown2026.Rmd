---
title: "Encuentro 5: Reportes con Rmarkdown"
...
## ✔️ ¿Qué es Rmarkdown (R + Mardown)?

## ✔️ Conceptos básicos de Markdown (Es un lenguaje)

## ✔️ YAML, chunks y texto
*"Yet Another Markup Language"* se traduce como "Otro lenguaje de marcado más" o "Un lenguaje de marcado más".
...
---
# Flujo de Trabajo de las Ciencias Sociales Computacionales
...
## Rmarkdown es un formato de Rstudio que permite combinar la **sintaxis de Markdown** para escritura de texto plano con la **sintaxis de R** para el procesamiento de datos.
...
---
###**Paquete xaringan** se usa para crear presentaciones en formato HTML con un estilo flexible. Está basado en remark.js, un marco de presentaciones en JavaScript y permite generar diapositivas directamente desde un archivo RMarkdown (.Rmd).

### **Paquete bookdown** permite escribir libros, informes y documentos extensos en R Markdown y exportarlos a PDF, HTML o EPUB.

### **Paquete blogdown**: Para crear blogs y sitios web con R Markdown.

---
# ¿Cómo generar un R Markdown? 
...
---
# Rmarkdown -  Estructura del chunk
...
---
# Rmarkdown - Configuración del chunk
